...
class HunarVoiceService:
    ...
    async def trigger_outbound_call(
        ...
        """
        Triggers an outbound voice screening call through the Hunar Voice API with
        connection pooling and exponential backoff retries.
        """
        ...
        agent_id = getattr(settings, "HUNAR_AGENT_ID", "8bbc73ee-01f7-4d30-96fb-3d4af2f07121")
    ...
    async def get_call_status(self, call_id: str) -> Dict[str, Any]:
        """
        Retrieves real-time status and transcript for a call with retries.
        """
